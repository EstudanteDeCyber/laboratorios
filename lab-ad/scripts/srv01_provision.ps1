# ===============================
# SRV01_PROVISION.PS1 - CONFIGURACAO DE REDE E JOIN AO DOMINIO
# ===============================

Write-Host "=== AJUSTANDO REDE NO SRV01 ===" -ForegroundColor Cyan
...
try {
    ...
    Write-Host ("SRV01 FOI ADICIONADO AO DOMINIO {0} E SERA REINICIADO" -f $domainName) -ForegroundColor Green
} catch {
    Write-Host ("ERRO AO ADICIONAR SRV01 AO DOMINIO: {0}" -f $_.Exception.Message) -ForegroundColor Red
}
